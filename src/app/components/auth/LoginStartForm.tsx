    ...
    <div className="flex flex-col justify-center items-center  min-h-screen">
      <div className="flex flex-col justify-center items-center bg-gray-100 gap-10">
        <div className="flex justify-center items-center">
          <Image src="/logo_Z.jpg" alt="Logo" width={200} height={200} className="mx-auto" />
        </div>
        ...
        <div className="flex justify-cener items-center">
          <button onClick={handleKakaoLogin} className="py-200 px- rounded-md w-64 flex items-center justify-center">
            <Image src="/kakao_login_large_narrow.png" alt="Kakao Logo" width={160} height={200} />
          </button>
        </div>
      </div>
    </div>
